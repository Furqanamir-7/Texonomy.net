          ...
          {industries.map((industry) => {
            ...
            return (
              <motion.div key={industry.name} variants={staggerItem}>
                <div className="group rounded-[28px] bg-card p-6 card-shadow text-center transition-all duration-500 hover:card-shadow-hover hover:-translate-y-1 cursor-default">
