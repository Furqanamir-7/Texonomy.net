          ...
          <StaggerContainer className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {fabricProducts.map((product) => (
              <motion.div key={product.name} variants={staggerItem}>
                <div className="group rounded-[28px] bg-card p-8 card-shadow h-full transition-all duration-500 hover:card-shadow-hover hover:-translate-y-2 overflow-hidden">
